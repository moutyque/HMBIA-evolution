...
# pdf_similar("webscraping/2021_01_07/Armor-and-weapon-surface-final-version-1.pdf", "webscraping/2021_01_26/Armor-and-weapon-surface-final-version-1.pdf")
            ...
            try:
                ...
                if (ImageChops.difference(pdf2_image, pdf1_image).getbbox() is None):
                    ...
                    print('The file didnt match for: \n>>%s\nand\n>>%s' % (
                        self.download_dir + os.sep + pdf2_img, self.download_dir + os.sep + pdf1_img))
            except Exception as e:
